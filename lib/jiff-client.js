...
(function (exports, node) {
  ...
  function receive_triplet(jiff, triplet_id, triplet) {
    if(jiff.deferreds[triplet_id] == null) return;
  ...
  function receive_server_share_number(jiff, numbers) {
    if(jiff.deferreds[numbers[0]["number_id"]] == null) return;
   ...
   * @param {array} senders_list - array of party ids to receive from, by default, this includes all parties. [optional]
   * @param {number} Zp - the modulos (if null then the default Zp for the instance is used). [optional]
   * @param {string|number} share_id - the base tag used to tag the messages sent by this share operation, every element of the array
  ...
  function make_jiff(hostname, computation_id, options) {
    ...
    if(jiff.keymap == null) jiff.keymap = {};
    ...
    jiff.resolve_messages_waiting_for_keys = function() {
      for(var party_id in jiff.keymmap) {
        if(!jiff.keymmap.hasOwnProperty(party_id)) continue;
        ...
        for(var i = 0; i < messageQueue.length; i++) {
          ...
          if(msg.label == 'share')
            ...
            throw "Error resolving pending message: unknown label " + msg.label;
        }
